...
public abstract class AbstractCAbilityBuild extends AbstractCAbility implements CAbilityMenu {
	...
	public static boolean isBuildLocationObstructed(CSimulation simulation, CUnitType unitTypeToCreate,
			RgbaImage buildingPathingPixelMap, boolean canBeBuiltOnThem, float targetX, float targetY, CUnit worker,
			BuildOnBuildingIntersector buildOnBuildingIntersector) {
	...
	public static void roundTargetPoint(Vector2 point, CUnitType unitType) {
		final RgbaImage buildingPathingPixelMap = unitType.getBuildingPathingPixelMap();
